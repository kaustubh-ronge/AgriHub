...
// --- 1. Define Types ---
// Matches the updated query structure
interface Nursery {
  _id: string;
  title: string;
  slug: string; // Now correctly a string
  description?: string;
  image?: string; // Now correctly a string URL
  address?: string;
  phoneNumber?: string;
  email?: string;
  rating?: number;
    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="relative h-[400px] w-full bg-green-50 overflow-hidden">
        {nursery.image ? (
          <Image
            unoptimized
            src={nursery.image} // This is now a URL string
            alt={nursery.title}
            fill
            className="object-cover"
            priority
