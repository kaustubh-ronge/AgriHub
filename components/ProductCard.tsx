...
// //   return (
// //     <div className="text-sm border-[1px] border-dark_blue/20 rounded-md bg-white group flex flex-col">
...
//         {product?.categories && (
//           <p className="uppercase line-clamp-1 text-xs text-shop_light_text">
//             {/* Make sure categories are fetched as titles */}
//             {product?.categories
...
//         {/* ✅ ADDED: Show the new shortDescription */}
//         {product.shortDescription ? (
//           <p className="text-xs text-gray-500 line-clamp-2 mt-1 min-h-[2.5em]">
//             {product.shortDescription}
//           </p>
//         ) : (
//           <div className="min-h-[2.5em]" /> // Placeholder to keep card height consistent
//         )}
