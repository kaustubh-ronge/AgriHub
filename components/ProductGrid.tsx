...
// // Tabs for the owner's sections
// const productTabs = [
//   { title: "Nursery (Tarkari)", value: "plants" },
...
//   // Fetch updated fields including tray info and stock
//   const query = `*[_type == "product" && productVariant == $variant] | order(name asc){
//     ...,
//     "slug": slug,
//     "categories": categories[]->{title},
//     "plantBreedData": plantBreedData->, // 👈 Fetch full breed data
//     "fertilizerFormulaData": fertilizerFormulaData->, // 👈 Fetch full formula data
//     trayPlantCount,
//     trayPrice,
//     isForSale,
//     whatsAppNumber,
...
// //             <p className="mt-4 text-sm font-medium text-gray-500">Fetching fresh stock...</p>
// //         </div>
// //       ) : products?.length ? (
...
//             <p className="mt-4 text-lg font-bold text-gray-500">Fetching fresh stock...</p>
//         </div>
//       ) : products?.length ? (
//         // ✅ CHANGED: grid-cols-1 md:grid-cols-2 lg:grid-cols-2 (Makes cards much larger)
